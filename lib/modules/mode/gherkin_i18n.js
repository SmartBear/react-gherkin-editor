...
ace.define('ace/mode/gherkin_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], function (acequire, exports, module) {
  ...
  const GherkinHighlightRules = function () {
    const labels = (0, _gherkin_i18n.getGherkinDialect)().labels;
    const keywords = (0, _gherkin_i18n.getGherkinDialect)().keywords;
    this.$rules = {
      start: [{
...
ace.define('ace/mode/gherkin_i18n', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/gherkin_highlight_rules'], function (acequire, exports, module) {
  const oop = acequire('../lib/oop');
