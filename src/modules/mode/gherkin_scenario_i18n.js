...
import { getGherkinDialect } from 'modules/dialects/gherkin_scenario_i18n'
...
define('ace/mode/gherkin_scenario_i18n', [
  'require',
  'exports',
  'module',
  'ace/lib/oop',
  ...
  const GherkinHighlightRules = acequire('./gherkin_scenario_highlight_rules')
